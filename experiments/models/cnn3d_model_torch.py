...
from networks.rayleigh_benard.cnn3d_torch import RB3DConv, RBPooling, RBUpsampling

#? info: torch Conv3d uses he initialization
...
class RB3DAutoEncoder(nn.Sequential):
    def __init__(self, 
        ...
        for i, out_channels in enumerate(encoder_channels, 1):
            ...
            layers.append(_Conv3DBlock(in_channels=in_channels, out_channels=out_channels, 
        ...
        # Out Conv
        layers.append(_Conv3DBlock(in_channels=in_channels, out_channels=4, 
                                 in_dims=in_dims, v_kernel_size=v_kernel_size, h_kernel_size=h_kernel_size,
    ...
    def forward(self, input: Tensor) -> Tensor:
        ...
        # reshape back to [batch, height*channels, width, depth]
